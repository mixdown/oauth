 ...
 * @param {Object}                 [options] Overrides to default options.
 ...
 */
OAuth.prototype.handleAuthCallback = function (params, options, callback) {
    var that = this;

    // if options is omitted, the second argument is the callback function.
    ...
    if (params.error) {
        ...
        this.oauth2Client.getOAuthAccessToken(params.code, _.defaults(options, this.tokenUrlDefaults), function (err, accessToken, refreshToken, results) {
